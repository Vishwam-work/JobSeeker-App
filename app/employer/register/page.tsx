...
export default function EmployerRegister() {
  ...
  useEffect(() => {
    if (formData.countryId) {
      fetch(
        `http://127.0.0.1:8010/https://jobseeker-backend-jy1y.onrender.com/master/api/states/?country_id=${formData.countryId}`
      )
        .then((res) => res.json())
        .then(setStates)
        .catch(console.error);
  ...
  useEffect(() => {
    if (formData.stateId) {
      fetch(
        `http://127.0.0.1:8010/https://jobseeker-backend-jy1y.onrender.com/master/api/cities/?state=${formData.stateId}`
      )
        .then((res) => res.json())
        .then(setCities)
        .catch(console.error);
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      const response = await fetch(
        "http://127.0.0.1:8010/https://jobseeker-backend-jy1y.onrender.com/employeer/api/employeer_register/",
        {
          method: "POST",
          headers: {
