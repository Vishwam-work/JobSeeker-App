  ...
  const faqData = [
    {
      ...
      answer:
        "Search for jobs, open job details, and click Apply button to submit your application.",
    },
    {
      question: "Can I apply without registration?",
      answer: "Most job portals require registration before applying to jobs.",
    },
    {
      question: "How do I track my applications?",
      answer:
        "You can track applied jobs from your dashboard under My Applications.",
    },
    {
      question: "Can I apply to multiple jobs?",
      answer:
        "Yes, you can apply to multiple jobs based on your skills and profile.",
    },
  ];
