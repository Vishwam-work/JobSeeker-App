...
export default function CreateProfileFAQPage() {
  const faqData = [
    {
      question: "How do I create a profile?",
      answer:
        "Click on Sign Up, fill in your details, verify your email, and complete your profile information.",
    },
    {
      question: "What details should I add to my profile?",
      answer:
        "Add your education, skills, work experience, resume, and contact information for better visibility.",
    },
    {
      question: "Can I edit my profile later?",
      answer:
        "Yes, you can update your profile anytime from your dashboard settings.",
    },
    {
      question: "Why is profile completion important?",
      answer:
        "A complete profile helps recruiters find you easily and increases job application success.",
    },
  ];
