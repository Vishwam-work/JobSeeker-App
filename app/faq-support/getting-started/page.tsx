...
export default function GettingStarted() {
  const faqData = [
  {
    ...
    answer: "Create an account, complete your profile, and begin searching for jobs.",
  },
  {
    question: "What should I do after registration?",
    answer: "Upload your resume and complete profile details for better visibility.",
  },
  {
    question: "How can I improve my profile?",
    answer: "Add skills, education, work experience, and certifications.",
  },
  {
    question: "Why should I verify my email?",
    answer: "Email verification helps secure your account and enables notifications.",
  },
];
