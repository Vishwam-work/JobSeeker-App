...
export default function Profile() {
  ...
  useEffect(() => {
    if (profileData.personalInfo.countryId) {
      fetch(
        `http://127.0.0.1:8010/https://jobseeker-backend-jy1y.onrender.com/master/api/states/?country_id=${profileData.personalInfo.countryId}`
      )
        .then((res) => res.json())
        .then((data) => {
          setStates(data);
  ...
  useEffect(() => {
    if (profileData.personalInfo.stateId) {
      fetch(
        `http://127.0.0.1:8010/https://jobseeker-backend-jy1y.onrender.com/master/api/cities/?state=${profileData.personalInfo.stateId}`
      )
        .then((res) => res.json())
        .then(setCities)
        .catch((err) => console.error(err));
  ...
  useEffect(() => {
    fetch("http://127.0.0.1:8010/https://jobseeker-backend-jy1y.onrender.com/master/api/companies/")
      .then((res) => res.json())
      .then((data) => {
        setCompanies(data);
      })
  ...
  useEffect(() => {
    if (experienceForm.category) {
      fetch(
        `http://127.0.0.1:8010/https://jobseeker-backend-jy1y.onrender.com/master/api/jobs_title/?category=${experienceForm.category}`
      )
        .then((res) => res.json())
        .then((data) => {
          setJobTitles(data);
  ...
  const uploadResume = async () => {
    ...
    const res = await fetch(
      "http://127.0.0.1:8010/https://jobseeker-backend-jy1y.onrender.com/api/profile/upload-resume/",
      {
        method: "PATCH",
        headers: {
