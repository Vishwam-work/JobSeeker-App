          ...
          <div className="hidden md:flex items-center space-x-4">
            ...
            <div className="relative">
              <button
                ...
                onBlur={() => setTimeout(() => setIsEmployerDropdownOpen(false), 200)}
              >
              ...
              {isEmployerDropdownOpen && (
                <div className="absolute right-0 mt-2 w-56 bg-white rounded-lg shadow-lg border border-gray-200 py-2 z-50">
                  <Link href="/employer/login" className="block px-4 py-2 text-sm text-gray-700 hover:bg-purple-50 hover:text-purple-600 transition-colors">
                    Employer Login
                  </Link>
                  <Link href="/employer/register" className="block px-4 py-2 text-sm text-gray-700 hover:bg-purple-50 hover:text-purple-600 transition-colors">
          ...
          <div className="md:hidden border-t bg-white py-4">
            <nav className="flex flex-col space-y-4">
              ...
              <div className="border-t pt-4">
                ...
                <Link href="/employer/login" className="block px-2 py-1 text-gray-700 hover:text-purple-600 transition-colors">
                  Employer Login
                </Link>
              </div>
              <div className="flex flex-col space-y-2 pt-4 border-t">
                {isAuthenticated ? (
                  <>
                    <Button variant="outline" className="w-full border-red-600 text-red-600 hover:bg-red-50" onClick={handleLogout}>
                      Logout
                    </Button>
                    <Link href="/profile">
